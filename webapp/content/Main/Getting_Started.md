...
This is a simple guide on how to get started with Doggy Talents Next.
...
*Note:*
- Trained Dogs are now becoming [Immortal](Behaviors/Immortal_Dogs).
- ***(DTN 1.18.21+)*** Now you can breed your dogs with the [Breeding Bone](Breeding_Bone).
- They have [nourishment points](Behaviors/Basic_Core_Stats#Nourishment_Points), which means having food in your inventory is a must. You don’t want your furry friend to starve.
