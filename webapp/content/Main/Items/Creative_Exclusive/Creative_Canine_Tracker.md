...
**Creative Canine Tracker** is an item that locates the position of a dog regardless of the [Radio Collar](Radio_Collar).

Its functions are the same as the [Canine Tracker](Canine_Tracker).
