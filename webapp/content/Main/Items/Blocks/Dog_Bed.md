...
If [Immortal Dogs](Immortal_Dogs) is set to False: This block allows a slain dog to be respawned (picked at random). 
...
- Bone or [Training Treat](Training_Treat) can also be used to make dogs claim their beds.
