...
title: Pack Puppy
---
Grants your dog dedicated inventory slots and the ability to automatically pick up items or share food with the pack.
...
Additionally, at **level 4**, if there is **meat** in its inventory, it will **offer it to other hungry dogs** who are nearby. [Egg Sandwich](Egg_Sandwich) will also be offered if other dogs are **low on health.**
...
- Dogs will not eat nor offer other dogs raw foods from the **Pack Puppy** inventory, preventing them from eating the food that the player stores inside **Pack Puppy** inventory for later cooking purposes.
- This talent is necessary for lower level (less than 5) [Doggy Torch](Doggy_Torch).
- If the **Pack Puppy** is wearing a dyed [Wool Collar](Wool_Collar), the Dog Inventory slots also have the same color as the collar's color.
